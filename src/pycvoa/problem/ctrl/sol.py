...
def is_assigned_element(layer_variable, element, solution_structure:dict):
...
def is_assigned_component_element(layer_vector_variable, element, index, solution_structure:dict):
...
def vector_removal_available(vector_variable, vector_size, domain:Domain):
    if domain.get_remaining_available_components(vector_variable, vector_size) < 0:
...
def assigned_vector_removal_available(vector_variable, solution_structure:dict, domain:Domain):
    ...
    vector_removal_available(vector_variable, len(solution_structure.get(vector_variable)), domain)
