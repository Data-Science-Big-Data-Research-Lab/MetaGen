...
# Correct:
external_worst.set_basic("I", 3, domain)
...
external_worst.set_domain(domain)
...
solution.set_element("L", "LI", 3, domain)
solution.set_element("L", "LR", 1.55, domain)
solution.set_element("L", "LC", "Lb1", domain)
