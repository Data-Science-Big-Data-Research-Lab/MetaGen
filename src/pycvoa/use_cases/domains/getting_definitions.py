...
# To get the remaining avialable components of a VECTOR variable, use the "get_remaining_available_components" method.
...
current_size = 10
r_components = domain.get_remaining_available_components("V_I", current_size)
