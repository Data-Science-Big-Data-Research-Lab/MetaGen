...
lstm_domain.define_dynamic_structure("arch", 2, 10)
lstm_domain.define_group("layer")
lstm_domain.define_integer_in_group("layer", "neurons", 25, 300)
lstm_domain.define_categorical_in_group("layer", "activation", ["relu", "sigmoid", "softmax", "tanh"])
lstm_domain.define_real_in_group("layer", "dropout", 0.0, 0.45)
lstm_domain.set_structure_to_variable("arch", "layer")
