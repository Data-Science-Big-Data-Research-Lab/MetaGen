...
from metagen.metaheuristics import (GA, SA, SSGA, TPE, KernelTPE, GAConnector, HillClimbing, TabuSearch,
...
ALGORITHMS = ("RandomSearch", "SA", "HillClimbing", "TabuSearch", "GA", "SSGA", "TPE", "KernelTPE", "Memetic")
...
def _build(name: str, problem: _Problem, fitness, seed: int, log_dir: str):
    ...
    if name == "KernelTPE":
        ...
        return KernelTPE(problem.domain(), fitness, max_iterations=360,
                            warmup_iterations=5, seed=seed, log_dir=log_dir)
    if name == "Memetic":
