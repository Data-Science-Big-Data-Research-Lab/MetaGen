...
Google Colab Notebook with a related example, tuning a stochastic gradient descent regressor: `SGD regressor <https://colab.research.google.com/github/Data-Science-Big-Data-Research-Lab/MetaGen/blob/master/notebooks/suc_p3.ipynb>`_
